...
/workspace/isaaclab/isaaclab.sh -p /workspace/isaaclab_extension_template/scripts/reinforcement_learning/rsl_rl/train.py \
  ...
  --max_iterations=500\
  --resume \
  --load_run=2026-05-24_02-43-59 \
  --checkpoint=model_1395.pt \
  --headless
...
/workspace/isaaclab/isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \
  --task=RobotLab-Isaac-Velocity-Flat-ATDog-Dog_Arm-v0 \
  --checkpoint=/workspace/isaaclab_extension_template/logs/rsl_rl/atdog_arm_flat/2026-05-24_06-27-50/model_1894.pt \
  --num_envs=1\
  --headless
...
scp -P 3022 sw@shenweitechnology.com:/home/sw/code/AT_rl_sar/logs/rsl_rl/atdog_arm_flat/2026-05-24_06-27-50/exported/policy.onnx ~/桌面/
