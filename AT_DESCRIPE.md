...
/workspace/isaaclab/isaaclab.sh -p /workspace/isaaclab_extension_template/scripts/reinforcement_learning/rsl_rl/train.py \
  ...
  --max_iterations=500\
  --resume \
  --load_run=2026-05-24_07-24-41 \
  --checkpoint=model_2393.pt \
  --headless
...
/workspace/isaaclab/isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \
  --task=RobotLab-Isaac-Velocity-Flat-ATDog-Dog_Arm-v0 \
  --checkpoint=/workspace/isaaclab_extension_template/logs/rsl_rl/atdog_arm_flat/2026-05-24_08-21-53/model_2892.pt \
  --num_envs=1\
  --headless
...
scp -P 3022 sw@shenweitechnology.com:/home/sw/code/AT_rl_sar/logs/rsl_rl/atdog_arm_flat/2026-05-24_08-21-53/exported/policy.onnx ~/桌面/
