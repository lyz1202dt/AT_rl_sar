...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.45, 0.45, 0.42), roughness=0.8),
        debug_vis=False,
    )
    # robots
    ...
    sky_light = AssetBaseCfg(
        ...
        spawn=sim_utils.DomeLightCfg(color=(0.75, 0.78, 0.82), intensity=750.0),
    )
