...
class ATDogDog2BarEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.body_lin_acc_l2.weight = -2.0e-4
        ...
        self.rewards.feet_air_time_variance.weight = -6.0
