...
from .rough_env_cfg import ATDogDog2AmpRoughEnvCfg


@configclass
class ATDogDog2AmpFlatEnvCfg(ATDogDog2AmpRoughEnvCfg):
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "ATDogDog2AmpFlatEnvCfg":
