...
@dataclass
class ATDogDog2RoughTrainerCfg(TrainerCfg):
...
@dataclass
class ATDogDog2SandTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
...
@dataclass
class ATDogDog2SlopeTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
...
@dataclass
class ATDogDog2StairsTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
