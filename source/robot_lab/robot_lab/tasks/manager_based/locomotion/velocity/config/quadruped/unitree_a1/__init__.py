...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_him_cfg_entry_point": f"{agents.__name__}.rsl_rl_him_cfg:UnitreeA1FlatHIMRunnerCfg",
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_him_cfg_entry_point": f"{agents.__name__}.rsl_rl_him_cfg:UnitreeA1RoughHIMRunnerCfg",
