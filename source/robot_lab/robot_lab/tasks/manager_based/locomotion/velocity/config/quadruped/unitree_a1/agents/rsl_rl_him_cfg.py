...
@configclass
class UnitreeA1RoughHIMRunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "HIMOnPolicyRunner"
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 100
    experiment_name = "unitree_a1_rough_him"
...
@configclass
class UnitreeA1FlatHIMRunnerCfg(UnitreeA1RoughHIMRunnerCfg):
    def __post_init__(self):
        super().__post_init__()
        self.max_iterations = 5000
        self.experiment_name = "unitree_a1_flat_him"
