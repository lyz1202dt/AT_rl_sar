...
@dataclass
class ATDogDog4RoughTrainerCfg(TrainerCfg):
...
# @dataclass
# class ATDogDog4SandTrainerCfg(TrainerCfg):
#     max_iterations = 20000
#     save_interval = 100
...
# @dataclass
# class ATDogDog4StairsTrainerCfg(TrainerCfg):
#     max_iterations = 20000
#     save_interval = 100
...
@dataclass
class ATDogDog4FlatTrainerCfg(ATDogDog4RoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "atdog_dog4_flat"
