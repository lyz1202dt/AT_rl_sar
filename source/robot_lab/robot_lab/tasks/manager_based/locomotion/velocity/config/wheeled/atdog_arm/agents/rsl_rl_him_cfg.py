...
@configclass
class ATDogArmRoughHIMRunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "HIMOnPolicyRunner"
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 100
    experiment_name = "atdog_arm_rough_him"
...
@configclass
class ATDogArmFlatHIMRunnerCfg(ATDogArmRoughHIMRunnerCfg):
    def __post_init__(self):
        super().__post_init__()

        self.max_iterations = 5000
        self.experiment_name = "atdog_arm_flat_him"
