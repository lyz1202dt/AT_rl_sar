...
DOG3_ROUGH_TERRAIN_CFG = terrain_gen.TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    num_cols=20,
...
@configclass
class ATDogDog3BarEnvCfg(LocomotionVelocityRoughEnvCfg):
    # 机身主刚体名称，用于:
    # 1) 传感器挂载（高度扫描器）
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator = DOG3_ROUGH_TERRAIN_CFG
        ...
        self.rewards.lin_vel_z_l2.weight = -15.0
        ...
        # 目标机身高度（单位 m）。
        self.rewards.base_height_l2.params["target_height"] = 0.15
        ...
        self.rewards.feet_air_time_variance.weight = -20.0
        ...
        self.rewards.feet_distance_y_exp.params["stance_width"] = 0.4
        ...
        if self.__class__.__name__ == "ATDogDog3BarEnvCfg":
