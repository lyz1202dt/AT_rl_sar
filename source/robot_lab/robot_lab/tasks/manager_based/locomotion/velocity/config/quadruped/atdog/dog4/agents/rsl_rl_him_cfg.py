...
@configclass
class ATDogDog4RoughHIMRunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "HIMOnPolicyRunner"
    num_steps_per_env = 24
    max_iterations = 20000
    save_interval = 100
    experiment_name = "atdog_dog4_rough_him"
...
@configclass
class ATDogDog4FlatHIMRunnerCfg(ATDogDog4RoughHIMRunnerCfg):
    def __post_init__(self):
        super().__post_init__()

        self.max_iterations = 5000
        self.experiment_name = "atdog_dog4_flat_him"
