...
@dataclass
class ATDogDog3RoughTrainerCfg(TrainerCfg):
...
@dataclass
class ATDogDog3SandTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
...
@dataclass
class ATDogDog3SlopeTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
...
@dataclass
class ATDogDog3StairsTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
...
@dataclass
class ATDogDog3FlatTrainerCfg(ATDogDog3RoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "atdog_dog3_flat"


@dataclass
class ATDogDog3BarTrainerCfg(ATDogDog3RoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "atdog_dog3_bar"
